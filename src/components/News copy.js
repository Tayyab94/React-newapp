...
export class News extends Component {
  ...
  async updateNews() {
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=ababd676b6fd4689a4e4a275d850403b&page=${this.state.page}&pageSize=${this.props.pageSize}`;
